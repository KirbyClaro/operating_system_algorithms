...
class PrioritySimulator:
    def __init__(self, root):
        ...
        tk.Label(main_frame, text="Priority CPU Scheduling", font=("Segoe UI", 16, "bold"), bg="#f4f4f9").pack(pady=(0, 10))
        ...
        ttk.Button(btn_frame, text="Run Simulation", command=self.calculate_priority).pack(side=tk.LEFT, padx=10)
        ...
        try:
            ...
            if mode == "Non-Preemptive":
                while completed_count < n:
                    ...
                    # Sort primarily by Priority, secondarily by Arrival Time (tie-breaker)
                ...
                while completed_count < n:
                    ...
                    # Sort primarily by Priority, secondarily by Arrival Time
                    available.sort(key=lambda x: (x["priority"], x["at"]))
                    current_process = available[0]
